...
`cloud-itonami-iso3166-chn` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Chinese-licensed counsel or a registered agent for whatever licensed
representation the law of China requires for public-procurement
filings.
